...
<div id="sidebar" class="sidebar-container">
    <div class="sidebar-content">
        ...
        <!-- Navigation Menu -->
        <nav class="nav-menu">
            <a href="home.blade.php" class="nav-item active">
            ...
            <a href="riwayat.blade.php" class="nav-item">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="penarikan.blade.php" class="nav-item">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="pengaturan.blade.php" class="nav-item">
                <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
